...
type TenantSpec struct {
	// Subdomain is the unique subdomain for this tenant, e.g. "pizza-palace"
	// +kubebuilder:validation:MinLength=1
	Subdomain string `json:"subdomain"`

	// AppImage is the container image to deploy for this tenant
	// +kubebuilder:validation:MinLength=1
	AppImage string `json:"appImage"`

	// Replicas is the number of app instances to run. Defaults to 1.
	// +optional
